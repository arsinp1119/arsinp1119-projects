...
public class ANPRPassageDetectionReq extends ANPRBusDetectionReq{

	/** The id of the message */
	public static final int ID = 9051;
	...
	public ANPRPassageDetectionReq() {
		super(ID, NAME);
	}
	
	public ANPRPassageDetectionReq(int ID, String NAME) {
		super(ID, NAME);
